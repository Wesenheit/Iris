...
MagCloud = {
    "I/355/gaiadr3": [
        ...
        ["GAIA_DR3_G", "GAIA_DR3_BP", "GAIA_DR3_RP"],
        0.3,
        [False, False, False],
    ],
    "II/246/out": [
        ["Hmag", "e_Hmag", "Kmag", "e_Kmag", "Jmag", "e_Jmag"],
    ...
    "II/365/catwise": [
        ["w1mpro_pm", "w1sigmpro_pm", "w2mpro_pm", "w2sigmpro_pm"],
        [
            "W1",
            "W2",
        ],
    ...
    "II/379/smssdr4": [
        ...
        ["u_SM", "v_SM", "r_SM", "i_SM", "g_SM", "z_SM"],
        0.3,
        [False, False, False, False, False, False],
    ],
    "J/AJ/123/855/table1": [
        ["Vmag", "e_Vmag", "Bmag", "e_Bmag", "Imag", "e_Imag", "Umag", "e_Umag"],
        ["V", "B", "I", "U"],
        0.3,
        [True, True, True, True],
    ],
    ...
    "II/335/galex_ais": [
        ["FUVmag", "e_FUVmag", "NUVmag", "e_NUVmag"],
        ["FUV", "NUV"],
        2.0,
        [True, True],
    ],
    ...
    "II/356/xmmom41s": [
        ["UVW2mAB ", "e_UVW2mAB ", "UVM2mAB", "e_UVM2mAB", "UVW1mAB", "e_UVW1mAB "],
        ["UVW2", "UVM2", "UVW1"],
        0.6,
        [True, True, True],
    ],
...
Galactic = {
    ...
    "II/316/gps6": [
        ...
        ["H_UKIDSS", "J_UKIDSS", "K_UKIDSS", "K_UKIDSS", "H_UKIDSS"],
        0.5,
        [True, True, True, True, True],
    ],
    "II/335/galex_ais": [
    ...
    "II/339/uvotssc1": [
        ...
        ["SWIFT_UVW2", "SWIFT_UVM2", "SWIFT_UVW1"],
        0.5,
        [True, True, True],
    ],
    "II/336/apass9": [
    ...
    "II/341/vphasp": [
        ["u_AB", "err_u", "g_AB", "err_g", "r_AB", "err_r"],
